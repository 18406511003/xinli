...
<div class= 'xinwencontent'>
  <div class="xinwenxf" style="text-align: center;">  <span style="color: #FFFFFF;font-family:'SimSun';font-size: 26px;">心理测评</span> </div>
    ...
    <div class="xinwencontent">
      <div class="biaoti">
      <span class="biaotifont">心理健康测试</span><br></br>
    </div>  
    <br><br>
...
var xf="这个测验测你想玩弄男人/女人的志愿度。由你的选择看来：";
if (form.c1[0].checked==1) form.answer.value=xf+"志愿度90%，令人羡慕。你在谈话方面信心颇高，不仅能留后路给对方，而且能顺利达到自己的目的。能完全掌握对方，玩弄于股掌之间！";
if (form.c1[1].checked==1) form.answer.value=xf+"志愿度70%，嘴甜会撒。将自己想像成有名的相声家，靠一张嘴的技巧，周旋在异性间。脚踏两船对你来说平常轻松，只要有手段，耍到对方团团转！";
if (form.c1[2].checked==1) form.answer.value=xf+"志愿度40%，太仁慈了点。虽也想试玩下，但每次都因同情而不能大胆行动，相反的，可能还被对方利用！";
if (form.c1[3].checked==1) form.answer.value=xf+"志愿度20%，是个认真的人。也许会以为抢眼的摇滚歌手，不可能带给人“吾乖”印象,其实这种志愿度只有20%，对玩弄他人，根本没兴趣！";
}
//-->
</SCRIPT>
...
<form name="see">
  <div align="center"><center><table border="0" cellpadding="10" cellspacing="0" width="586" height="1" bgcolor="#FFFFFF">
    <tr>
    <TD align=middle height=49 width="564" background="../page/image/bg.gif">
      <DIV align=left>
      <P><SPAN 
      style="FONT-SIZE: 20px; LINE-HEIGHT: 30px"><br>
      <font color="#000000">公司小妹不慎打破会客室的花瓶，这时你刚好走来，你有何高见？</font> 
      </SPAN></P></DIV>
      <DIV align=left>
      <P><SPAN style="FONT-SIZE: 20px; LINE-HEIGHT: 30px"><font color="#000000"><INPUT name=c1 
      type=radio value=1>先跟秘书谈谈她会替你解决。<BR><INPUT name=c1 type=radio 
      value=3>不要紧我替你想办法。<BR><INPUT name=c1 type=radio 
      value=V1>坏了就坏了管它的。<BR><INPUT name=c1 type=radio 
      value=V2>董事长人很好道个歉就行了。<BR><INPUT name=c1 type=radio 
      value=V3>这只花瓶好几万真糟糕。</font></SPAN></P></DIV>
      <P><INPUT onclick=processForm(this.form) style="FONT-FAMILY: 宋体; FONT-SIZE: 20px" type=button value=已选好，看看结论!>  
      <INPUT onclick=processForm(this.form) style="FONT-FAMILY: 宋体; FONT-SIZE: 20px" type=reset value=重新选！></P>
      <P><TEXTAREA cols=48 name=answer rows=4 style="COLOR: rgb(255,0,0); FONT-FAMILY: 宋体; FONT-SIZE: 20px; LINE-HEIGHT: 30px" wrap=virtual></TEXTAREA></P></TD>
    </tr>
  </table>         
  </center></div>         
</form>                                    

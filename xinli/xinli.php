...
<div class= 'xinwencontent'>
  <div class="xinwenxf" style="text-align: center;">  <span style="color: #FFFFFF;font-family:'SimSun';font-size: 26px;">心理测评</span> </div>
    ...
    <div class="ttu"> 
    <li class="tupian">
     <a href= "xlcs_1.php"><img src="assets/img/xl_1.jpg" href=" " > EQ心理年龄 </a></li>  
    <li class="tupian">
     <a href= "xlcs_2.php"><img src="assets/img/xl_2.jpg" href=" " > 人际关系的测试 </a></li>
    <li class="tupian">
     <a href= "xlcs_3.php"><img src="assets/img/timg.jpg" href=" " > 日常心理反射 </a></li>
    </div>
   <!--  <div class="page_fan">
      <ul style="display:inline-block">
        <li><a href="#" style="color:red;border-bottom:1px solid red">1</a></li>
        <li><a href="aiqing_2.php">2</a></li>
        <li><a href="#">3</a></li>
        <li><a href="#">4</a></li>
        <li><a href="#">5</a></li>
        <li><a href="#">6</a></li>

...
<div class= 'xinwencontent'>
  <div class="xinwenxf" style="text-align: center;">  <span style="color: #FFFFFF;font-family:'SimSun';font-size: 26px;">心理测评</span> </div>
    ...
    <div class="ttu"> 
    <li class="tupian">
     <a href= "aqcs_1.php"><img src="assets/img/aiqing_1.jpg" href=" " > 由电话看出你对感情的态度 </a></li>  
    <li class="tupian">
     <a href= "aqcs_2.php"><img src="assets/img/aiqing_2.jpg" href=" " > 恋爱中你会付出多少？ </a></li>
    <li class="tupian">
     <a href= "aqcs_3.php"><img src="assets/img/aiqing_3.jpg" href=" " > 梦中的爱人 </a></li>
    </div>
    <div class="page_fan">

...
<div class= 'xinwencontent'>
  <div class="xinwenxf" style="text-align: center;">  <span style="color: #FFFFFF;font-family:'SimSun';font-size: 26px;">心理测评</span> </div>
    ...
    <div class="ttu"> 
    <li class="tupian">
     <a href= "sjcs_1.php"><img src="assets/img/sj_1.jpg" href=" " > 你善于交际吗？ </a></li>  
    <li class="tupian">
     <a href= "sjcs_2.php"><img src="assets/img/sj_2.jpg" href=" " > 你留给人的第一印象如何？ </a></li>
    <li class="tupian">
     <a href= "sjcs_3.php"><img src="assets/img/nvhai.jpg" href=" " > 你是受欢迎的人吗？ </a></li>
    </div>
   <!--  <div class="page_fan">

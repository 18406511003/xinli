...
<div class= 'xinwencontent'>
  <div class="xinwenxf" style="text-align: center;">  <span style="color: #FFFFFF;font-family:'SimSun';font-size: 26px;">心理测评</span> </div>
    ...
    <div class="ttu"> 
    <li class="tupian">
     <a href= "aqcs_4.php"><img src="assets/img/aiqing_2.jpg" href=" " > 如何成为他的理想女友？ </a></li>  
    <!-- <li class="tupian">
     <a href= "aqcs_5.php"><img src="assets/img/aiqing_2.jpg" href=" " > 恋爱中你会付出多少？ </a></li>
    <li class="tupian">
     <a href= "aqcs_6.php"><img src="assets/img/aiqing_3.jpg" href=" " > 梦中的爱人 </a></li> -->
    </div>
    <div class="page_fan">
      <ul style="display:inline-block">
        <li><a href="aiqing.php">1</a></li>
        <li><a href="aiqing_2.php"  style="color:red;border-bottom:1px solid red">2</a></li>
  <!--       <li><a href="#">3</a></li>
        <li><a href="#">4</a></li>
        <li><a href="#">5</a></li>
        <li><a href="#">6</a></li>
